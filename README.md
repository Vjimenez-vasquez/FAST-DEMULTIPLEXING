...
# 1. Considerations
```r
1. Las secuencias solo requieren el barcode de la muestra
2. multiples nucleos
3. contar con un archivo de "barcodes"
```

# 2. Barcodes.txt (tab separated; first column: sample_name ; second column: sample_barcode)
```r
Lib09_139_2	AACT
Lib09_139_6_Duplicate	CCGTCA
Lib09_140_1	CCAG
Lib09_142_9	TTGA
Lib09_144_6	GGTA
Lib09_145_4	ATTG
